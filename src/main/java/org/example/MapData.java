...
//        List<Integer> shortestPath = finder.dijkstra(graph, start, finish);
//
//        if (shortestPath == null) {
//            return null;
//        }
//
//        return constructPath(shortestPath);
//
//    }
//
//    private List<String> constructPath(List<Integer> shortestPath) {
//        List<String> path = new ArrayList<>();
//
//        for (int i = 0; i < shortestPath.size() - 1; i++) {
//            int current = shortestPath.get(i);
//            int next = shortestPath.get(i + 1);
//
...
//            }
//
//            path.add((i + 1) + ". Move " + direction + " to (" + (nextX + 1) + ", " + (nextY + 1) + ")");
//        }
//        path.add("18. Done!");
//
//        return path;
